...
function storedDirection(overrides: Partial<VisualDirection> = {}): VisualDirection {
  return {
    ...
    subject: ["coffee poured at a café counter before it opens"],
    ...
    lines: [
      { line: "Photograph the work itself, where it happens.", basis: "https://instagram.com/p/abc", confidence: "high" },
