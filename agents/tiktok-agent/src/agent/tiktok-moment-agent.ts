 ...
 *
 * The model is Gemini 3.1 Pro on Vertex, and that is a fit, not a cost cut: a
...
export class TikTokMomentAgent extends BaseAgent<MomentSelection> {
  protected readonly config: AgentStepConfig<MomentSelection> = {
    ...
    modelPolicy: resolveModelPolicy("tiktok-moment", { policy: "pinned", model: "gemini-3.1-pro-preview", vendor: "gemini" }),
