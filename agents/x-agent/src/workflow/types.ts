...
export interface XSelectedCandidate {
   ...
   * on the client's never-list, and this run posted about something else.
   *
   ...
   * whoever asked finds out their request was declined and why — rather than
   * the run ending and nobody learning anything.
   */
