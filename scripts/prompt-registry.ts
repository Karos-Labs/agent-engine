...
export const PROMPT_REGISTRY: readonly PromptRegistryEntry[] = [
  ...
  { promptId: "branded-shorts-graphics", agent: "branded-shorts-agent", versions: ["1"], latestVersion: "1" },
  ...
  { promptId: "instagram-visual-qa", agent: "instagram-agent", versions: ["1"], latestVersion: "1" },
  {
