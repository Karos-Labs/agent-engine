...
const TAXONOMY = `read ${A.out}/taxonomy.json (judge:taxonomy) and ${A.out}/robustness-v2.json (re-test on 173 accounts: involvement strongest, then archetype and audience, then industry; audience best on carousels)`
phase('Compile')
const COMPILED = {
  type: 'object',
  properties: {
